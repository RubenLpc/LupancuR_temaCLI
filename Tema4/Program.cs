...
namespace Tema4
{
    public class Game : GameWindow
    {
        ...
        private Vector3 cameraPosition = new Vector3(8, 8, 8);
        ...
        private void SpawnCube()
        {
            var newCube = new Cube(
                position: new Vector3(
                    (float)(random.NextDouble() * 4.0 - 2.0), // X range: -2 to 2
                    (float)(random.NextDouble() * 6.0 + 2.0), // Y range: 2 to 8
                    (float)(random.NextDouble() * 4.0 - 2.0)  // Z range: -2 to 2
                ),
                size: (float)(random.NextDouble() * 0.7 + 0.3), // Size range: 0.3 to 1.0
                color: new Color4(
                    (float)(0.5 + random.NextDouble() * 0.5),  // More vibrant colors
                    (float)(0.5 + random.NextDouble() * 0.5),
                    (float)(0.5 + random.NextDouble() * 0.5),
                    1.0f
                )
            );
